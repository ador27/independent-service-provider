            ...
            <div className="flex justify-center mt-8">
                ...
                <div className="rounded-lg shadow-lg bg-white max-w-sm">
                    ...
                    <div className="p-6">
                        ...
                        <button type="button" onClick={() => navigateToServiceDetail(id)} className=" inline-block px-6 py-2.5 bg-orange-600 text-white font-medium text-xs leading-tight uppercase rounded shadow-md hover:bg-orange-700 hover:shadow-lg focus:bg-orange-700 focus:shadow-lg focus:outline-none focus:ring-0 active:bg-orange-800 active:shadow-lg transition duration-150 ease-in-out">Check-out</button>
                    </div>
                </div>
            </div>
        </div>
